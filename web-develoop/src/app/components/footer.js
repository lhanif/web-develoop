...
export default function Footer() {
  ...
  return (
        <footer class="relative w-full mb-20 bg-white">
        ...
        <img
            ...
            class="mt-8 h-auto max-h-8 object-contain ms"
            alt="Develoop Logo"
        />
        <p class="text-gray-600 text-sm mt-2 ms-8 me-7 text-justify">Develoop adalah sebuah perusahaan rintisan yang menawarkan jasa pembuatan produk digital, sistem IoT terintegrasi, dan produk inovatif lainnya. Dengan menggabungkan kreativitas, teknologi mutakhir, dan pemahaman mendalam akan kebutuhan bisnis Anda, kami menciptakan solusi digital yang berkualitas.</p>
            </div>
            
            <div class="grid justify-between grid-cols-3 gap-1 mt-10 ms-8 me-2">
                <ul>
                ...
                <ul>
                <p class="block mb-0 text-base font-semibold  text-slate-800">
                    FAQ
                </p>
                <li>
                    <a href="#" class="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                ...
                <li>
                    <a href="#" class="block mb-2 text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                    Pricing
                    </a>
                </li>
                <li>
                    <p class="block text-base font-semibold  text-slate-800">
                    About Us
                    </p>
                </li>
                <li>
                ...
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 64 64" id="email">
                ...
                <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="#222" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <li>
                <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 737.509 740.824" fill="#222" id="whatsapp">
        <path fill-rule="evenodd" d="M630.056 107.658C560.727 38.271 468.525.039 370.294 0 167.891 0 3.16 164.668 3.079 367.072c-.027 64.699 16.883 127.855 49.016 183.523L0 740.824l194.666-51.047c53.634 29.244 114.022 44.656 175.481 44.682h.151c202.382 0 367.128-164.689 367.21-367.094.039-98.088-38.121-190.32-107.452-259.707m-259.758 564.8h-.125c-54.766-.021-108.483-14.729-155.343-42.529l-11.146-6.613-115.516 30.293 30.834-112.592-7.258-11.543c-30.552-48.58-46.689-104.729-46.665-162.379C65.146 198.865 202.065 62 370.419 62c81.521.031 158.154 31.81 215.779 89.482s89.342 134.332 89.311 215.859c-.07 168.242-136.987 305.117-305.211 305.117m167.415-228.514c-9.176-4.591-54.286-26.782-62.697-29.843-8.41-3.061-14.526-4.591-20.644 4.592-6.116 9.182-23.7 29.843-29.054 35.964-5.351 6.122-10.703 6.888-19.879 2.296-9.175-4.591-38.739-14.276-73.786-45.526-27.275-24.32-45.691-54.36-51.043-63.542-5.352-9.183-.569-14.148 4.024-18.72 4.127-4.11 9.175-10.713 13.763-16.07 4.587-5.356 6.116-9.182 9.174-15.303 3.059-6.122 1.53-11.479-.764-16.07-2.294-4.591-20.643-49.739-28.29-68.104-7.447-17.886-15.012-15.466-20.644-15.746-5.346-.266-11.469-.323-17.585-.323-6.117 0-16.057 2.296-24.468 11.478-8.41 9.183-32.112 31.374-32.112 76.521s32.877 88.763 37.465 94.885c4.587 6.122 64.699 98.771 156.741 138.502 21.891 9.45 38.982 15.093 52.307 19.323 21.981 6.979 41.983 5.994 57.793 3.633 17.628-2.633 54.285-22.19 61.932-43.616 7.646-21.426 7.646-39.791 5.352-43.617-2.293-3.826-8.41-6.122-17.585-10.714" clip-rule="evenodd"></path>
                ...
                <li>
                <div class="flex items-center">
                <svg class="w-6 h-6 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="4 0 30 30" fill="#222" aria-hidden="true">
  <path d="M 7.5 5 C 6.132813 5 5 6.132813 5 7.5 L 5 24.5 C 5 25.867188 6.132813 27 7.5 27 L 24.5 27 C 25.867188 27 27 25.867188 27 24.5 L 27 7.5 C 27 6.132813 25.867188 5 24.5 5 Z M 7.5 7 L 24.5 7 C 24.785156 7 25 7.214844 25 7.5 L 25 24.5 C 25 24.785156 24.785156 25 24.5 25 L 7.5 25 C 7.214844 25 7 24.785156 7 24.5 L 7 7.5 C 7 7.214844 7.214844 7 7.5 7 Z M 10.4375 8.71875 C 9.488281 8.71875 8.71875 9.488281 8.71875 10.4375 C 8.71875 11.386719 9.488281 12.15625 10.4375 12.15625 C 11.386719 12.15625 12.15625 11.386719 12.15625 10.4375 C 12.15625 9.488281 11.386719 8.71875 10.4375 8.71875 Z M 19.46875 13.28125 C 18.035156 13.28125 17.082031 14.066406 16.6875 14.8125 L 16.625 14.8125 L 16.625 13.5 L 13.8125 13.5 L 13.8125 23 L 16.75 23 L 16.75 18.3125 C 16.75 17.074219 16.996094 15.875 18.53125 15.875 C 20.042969 15.875 20.0625 17.273438 20.0625 18.375 L 20.0625 23 L 23 23 L 23 17.78125 C 23 15.226563 22.457031 13.28125 19.46875 13.28125 Z M 9 13.5 L 9 23 L 11.96875 23 L 11.96875 13.5 Z"></path>
            ...
            <div class="flex flex-col items-center justify-center w-full py-4 mt-10 border-t border-slate-200 md:flex-row md:justify-between">
            <p class="block  mb-4 text-sm text-center text-slate-500 md:mb-0 ms-7">
                Copyright © 2024 
                <a href="https://material-tailwind.com/"> Develoop Studio</a>. All Rights Reserved.
            </p>
