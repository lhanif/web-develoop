      ...
      <div>
        ...
        <div className="bg-gray-100 dark:bg-gray-800">
                <div className="container px-6 py-5 mx-auto">
                    <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300 text-justify">
                    Develoop adalah perusahaan rintisan di bidang system development yang menyediakan layanan pembuatan produk digital, sistem IoT terintegrasi, dan solusi teknologi lainnya. Dengan pendekatan personal dan berfokus pada kebutuhan pelanggan, kami menciptakan solusi inovatif yang mendukung pertumbuhan bisnis Anda. Dream it, we’ll build it.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section className="bg-gray-100 dark:bg-gray-800">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Our Vision</h1>
